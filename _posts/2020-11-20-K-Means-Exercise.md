...
![png](https://i.ibb.co/y5SMbCX/output-12-1.png)
...
![png](https://i.ibb.co/YLNXgFG/output-14-1.png)
...
```python
sns.histplot(data=college, x='Outstate', hue='Private')
```



![png](https://i.ibb.co/XFSmbBN/output-16-1.png)
...
```python
sns.histplot(data=college, x='Grad.Rate', hue='Private')
```



![png](https://i.ibb.co/1QzkWg7/output-18-1.png)
...
```
    ...
    <ipython-input-21-c2676d5dc683>:1: SettingWithCopyWarning: 
...
![png](https://i.ibb.co/RyyJW7j/output-24-1.png)
...
```python
model.fit(college.drop(labels=['Private'], axis=1))
```
